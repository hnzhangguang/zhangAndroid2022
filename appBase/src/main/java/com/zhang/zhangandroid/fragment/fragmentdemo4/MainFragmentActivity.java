...
public class MainFragmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.fl_content_fragment, nlFragment);
        ft.commit();
    }


    private void bindViews() {
        txt_title = (TextView) findViewById(R.id.txt_title_fragment);
        fl_content = (FrameLayout) findViewById(R.id.fl_content_fragment);
    }
