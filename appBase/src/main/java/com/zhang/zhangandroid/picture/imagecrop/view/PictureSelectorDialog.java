 ...
 */
package com.zhang.zhangandroid.picture.imagecrop.view;
...
import com.zhang.zhangandroid.fragment.FragmentActivity;
...
public class PictureSelectorDialog extends BaseDialog implements View.OnClickListener {
    ...
    public View createView(Context context, LayoutInflater inflater, ViewGroup parent) {
        return inflater.inflate(R.layout.layout_picture_selector_imagecrop, parent, false);
    }
